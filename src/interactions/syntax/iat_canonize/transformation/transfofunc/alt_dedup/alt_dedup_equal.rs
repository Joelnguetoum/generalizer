...
use crate::interactions::syntax::util::fold_recursive_frags::fold_recursive_alt_frags;
use crate::interactions::syntax::util::get_recursive_frag::get_recursive_alt_frags;

pub fn transfo_alt_deduplicate(interaction : &Interaction) -> Vec<Interaction> {
