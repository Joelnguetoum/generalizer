...
use crate::interactions::io::output::draw_interactions::as_term::interaction_repr::repr::interaction_gv_repr;
...
pub fn draw_int_as_term(gen_ctx : &GeneralContext,
    ...
    let _ = file.write( interaction_gv_repr(gen_ctx,interaction).to_dot_string().as_bytes() );
    // ***
