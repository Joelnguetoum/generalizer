...
use image::RgbImage;
use maplit::btreeset;
use crate::interactions::io::output::draw_commons::sd_drawing_conf::{FONT_WIDTH, HORIZONTAL_SIZE, MARGIN, THICKNESS, VERTICAL_SIZE};
use crate::interactions::io::output::draw_interactions::as_sd::interaction_repr::img_content::draw_interaction_rec;
use crate::interactions::io::output::draw_interactions::as_sd::interaction_repr::img_frame::{draw_frame, draw_lifelines};
use crate::interactions::io::output::draw_interactions::as_sd::util::dimensions_tools::get_interaction_max_yshift;
