...
impl Configuration {
    pub fn can_apply_expand_u_right_decompose(&self) -> bool {
       self.can_apply_expand_u_right()
    }

    pub fn expand_u_right_decompose(&self) -> Result<Vec<Configuration>, ConfigurationError> {
